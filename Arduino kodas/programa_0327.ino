...
// TO DO:
// Pridėsim SD, Wifi, RFID skaitytuvo bibliotekas
...
// nežinau ar šitų puslapiu įsiminimas yra reikalingas, jei nereiks ištrinsim
...
void setup() {
  ...
  // pažiūrim ar laikrodis nenusinulinęs
